    ...
    build() {
        ...
        if (this.builder.config['dynamic'] && this.limit !== this.price) {
            ...
            if (this.builder.config['estimate'] && this.builder.config.volume != null) {
                ...
                primary.trigger.submit = `${symbol} STUDY '{tho=true};Between(SecondsTillTime(1000), ${-60 * 60 * 6 + 60 * 30}, 0) and Between(close, ${this.price.financial()}, ${this.limit.financial()}) and (close > Average(close, 3) and Average(close, 3) > Average(close, 5) and (close-low)/(high-low)>0.6) and (if (-SecondsTillTime(930)/60+10) == 10 then Sum(volume,1)/10*390 else if (-SecondsTillTime(930)/60+10) == 20 then Sum(volume,2)/20*390 else if (-SecondsTillTime(930)/60+10) == 30 then Sum(volume,3)/30*390 else if (-SecondsTillTime(930)/60+10) == 40 then Sum(volume,4)/40*390 else if (-SecondsTillTime(930)/60+10) == 50 then Sum(volume,5)/50*390 else if (-SecondsTillTime(930)/60+10) == 60 then Sum(volume,6)/60*390 else if (-SecondsTillTime(930)/60+10) == 70 then Sum(volume,7)/70*390 else if (-SecondsTillTime(930)/60+10) == 80 then Sum(volume,8)/80*390 else if (-SecondsTillTime(930)/60+10) == 90 then Sum(volume,9)/90*390 else if (-SecondsTillTime(930)/60+10) == 100 then Sum(volume,10)/100*390 else if (-SecondsTillTime(930)/60+10) == 110 then Sum(volume,11)/110*390 else if (-SecondsTillTime(930)/60+10) == 120 then Sum(volume,12)/120*390 else if (-SecondsTillTime(930)/60+10) == 130 then Sum(volume,13)/130*390 else if (-SecondsTillTime(930)/60+10) == 140 then Sum(volume,14)/140*390 else if (-SecondsTillTime(930)/60+10) == 150 then Sum(volume,15)/150*390 else if (-SecondsTillTime(930)/60+10) == 160 then Sum(volume,16)/160*390 else if (-SecondsTillTime(930)/60+10) == 170 then Sum(volume,17)/170*390 else if (-SecondsTillTime(930)/60+10) == 180 then Sum(volume,18)/180*390 else if (-SecondsTillTime(930)/60+10) == 190 then Sum(volume,19)/190*390 else if (-SecondsTillTime(930)/60+10) == 200 then Sum(volume,20)/200*390 else if (-SecondsTillTime(930)/60+10) == 210 then Sum(volume,21)/210*390 else if (-SecondsTillTime(930)/60+10) == 220 then Sum(volume,22)/220*390 else if (-SecondsTillTime(930)/60+10) == 230 then Sum(volume,23)/230*390 else if (-SecondsTillTime(930)/60+10) == 240 then Sum(volume,24)/240*390 else if (-SecondsTillTime(930)/60+10) == 250 then Sum(volume,25)/250*390 else if (-SecondsTillTime(930)/60+10) == 260 then Sum(volume,26)/260*390 else if (-SecondsTillTime(930)/60+10) == 270 then Sum(volume,27)/270*390 else if (-SecondsTillTime(930)/60+10) == 280 then Sum(volume,28)/280*390 else if (-SecondsTillTime(930)/60+10) == 290 then Sum(volume,29)/290*390 else if (-SecondsTillTime(930)/60+10) == 300 then Sum(volume,30)/300*390 else if (-SecondsTillTime(930)/60+10) == 310 then Sum(volume,31)/310*390 else if (-SecondsTillTime(930)/60+10) == 320 then Sum(volume,32)/320*390 else if (-SecondsTillTime(930)/60+10) == 330 then Sum(volume,33)/330*390 else if (-SecondsTillTime(930)/60+10) == 340 then Sum(volume,34)/340*390 else if (-SecondsTillTime(930)/60+10) == 350 then Sum(volume,35)/350*390 else if (-SecondsTillTime(930)/60+10) == 360 then Sum(volume,36)/360*390 else if (-SecondsTillTime(930)/60+10) == 370 then Sum(volume,37)/370*390 else if (-SecondsTillTime(930)/60+10) == 380 then Sum(volume,38)/380*390 else if (-SecondsTillTime(930)/60+10) == 390 then Sum(volume,39)/390*390 else Double.NaN) > ${avg};10m' IS TRUE`;
            }
        } else {
